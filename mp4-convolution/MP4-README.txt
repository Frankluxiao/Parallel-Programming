...
2) Edit the source files "2Dconvolution.cu" and "2Dconvolution_kernel.cu" to
   ...
   your code will produce the executable mp4-convolution in your SDK
...
4) Report:
   ...
   mp4-convolution folder is a folder called "test", which contains two test
...
5) Submit your solution via Moodle as a tarball. Your submission should
   contain the "mp4-convolution" folder provided, with all the changes and
